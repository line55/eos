...
(setq user-full-name "Carmine Casciato"
      user-mail-address "line@line55.com")
#+END_SRC
...
Set up the fill-column to 1000 characters and set tab width to 2
...
Search (and search/replace) using regex by default, since that's usually what I
want to do:
...
#+BEGIN_src emacs-lisp
;;(desktop-save-mode 1) ;;desktop+ not working for me
