...
:CUSTOM_ID: eos
:END:
The following is Lee Hinman's Emacs setup that I am currently modifying. I like
the modularity, and the many many packages it uses.

Here is Lee's opener:
...
- [[./eos-develop.org][Development (programming) System]] - various development settings
  ...
  - [[file:eos-js.org][JavaScript]] - JS (for my day job)
