...
(setq eos/original-variable-height 105)
...
(defun eos/setup-x11-fonts ()
  (when (eq window-system 'x)
    ...
    (set-face-attribute 'variable-pitch nil
                        :family "Bitstream Charter" :height eos/original-variable-height)
    (set-face-attribute 'company-tooltip nil :family "M+ 1mn" :height eos/original-height)
    ;; font for all unicode characters
    (set-fontset-font t 'unicode "Lato" nil 'prepend)))
...
l55: So it looks like the following can work, pretty simple
