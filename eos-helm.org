...
Also, use helm-fuzzier in addition to helm-flx
...
| C-x o | helm occur (search in buffer)                   |
| M-y     | helm kill ring                                  |
...
(use-package helm-swoop
  :ensure t
  :bind (("C-M-y" . helm-swoop)         ;don't mess with ergo keys
...
(global-set-key (kbd "C-x B") #'eos/popup-project-eshell)
#+END_SRC
